      ...
      <div className="container">
        <div className="grid gap-8 md:grid-cols-12 md:gap-12">
          <div className="md:col-span-4">
            ...
            <h2 className="display-2 mt-3 max-w-[14ch]">שאלות שאנחנו שומעים הכי הרבה.</h2>
              ...
              {faqs.map((f, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="text-[16px] font-bold leading-snug md:text-[18px]">
                        {f.q}
                      </span>
                      <span
                        className="mt-1 grid h-7 w-7 shrink-0 place-items-center rounded-full transition-all"
                        style={{
                    ...
                    {isOpen && (
                      <div className="pb-6 pe-12 text-[14px] leading-[1.7] text-[var(--ink-3)] md:text-[15px]">
                        {f.a}
                      </div>
                    )}
                  </li>
