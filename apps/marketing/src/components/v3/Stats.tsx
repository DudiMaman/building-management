/**
 * Stats spread — Ramp / Wealthfront-style large-figure-small-label.
 * Numbers run ltr, tabular-nums, with hairline rules between.
 */
    ...
    <section className="section" style={{ background: 'var(--bg)' }}>
      <div className="container">
        <div className="grid items-end gap-4 md:grid-cols-2 md:gap-10">
          <div>
            <div className="eyebrow-he">המספרים</div>
            <h2 className="display-2 mt-3 max-w-[18ch]">
              נדל"ן מנוהל נמדד במספרים.
            </h2>
          </div>
          <p className="text-[14px] text-[var(--ink-3)] md:text-end">
            מבוסס על נתונים אגרגטיביים של חברות הניהול בפלטפורמה לתחילת 2026.
            המעבר נמדד ע"י שלוש חברות שעברו מ-Excel ב-2025.
          </p>
        </div>
